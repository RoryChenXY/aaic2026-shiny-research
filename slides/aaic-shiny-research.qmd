...
-   A web element that your users can interact with and `send` messages to the Shiny app.
...
-   Open and run `05-uiinput.R`. It lists some commonly used input widgets
...
-    Let's open `./exercises/08-reactiveexp.R`
